...
from src.ss360.classify.rules import classify, _extract_jwt_expiry, _extract_azure_sas_expiry
...
class TestExpiryDetection:
    ...
    def test_azure_sas_extract_expiry(self):
        ...
        sas_url = f"https://storage.blob.core.windows.net/container/blob?se={exp_str}&sp=r"
