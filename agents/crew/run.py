...
DEFAULT_REPO_URL = os.getenv(
    "SCAN_REPO_URL", f"https://github.com/{REPO_FULL_NAME}.git"
)
...
def implement():
    ...
    return {
        ...
        "true_hits": result.get("true_hits"),
...
t1 = Task(
    description="Run SS360 scan and write report",
    agent=dev,
    expected_output="Report files created and pushed",
    func=implement,
    output_json=True,
)
