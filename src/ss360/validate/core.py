...
def _redact_evidence(evidence: str) -> str:
    ...
    for line in lines:
        # Look for patterns that might be secrets (longer alphanumeric strings with underscores)
        redacted_line = re.sub(
            r'\b[A-Za-z0-9+/_-]{16,}\b',  # Match secrets 16+ chars including underscores, hyphens
