...
def test_risk_scoring():
    ...
    assert 70 <= score <= 80, f"Expected score around 70, got {score}"  # Allow for modifiers
    ...
    assert prod_score > test_score, f"Production score {prod_score} should be > test score {test_score}"
